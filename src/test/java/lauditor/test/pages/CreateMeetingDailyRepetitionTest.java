...
public class CreateMeetingDailyRepetitionTest extends BaseClass {
	...
	public Object[][] getData0() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"F:\\ANANTH\\Eclipse-Workspace\\Law\\src\\test\\java\\Data\\Calendar\\Meeting\\createMeetingdataDaily.json");
		...
		return new Object[][] { { data.get(0) }, { data.get(1) }, { data.get(2) }, { data.get(3) }, { data.get(4) },
				...
				{ data.get(46) }, { data.get(47) }, { data.get(48) } };
