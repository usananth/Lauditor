...
public class CreateMeetingTestDailRepNew1 extends BaseClass {
	...
	public void RepetitionDailyWithAllDays(HashMap<String, String> input) throws InterruptedException {
	...
	public Object[][] getData0() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"F:\\ANANTH\\Eclipse-Workspace\\Law\\src\\test\\java\\Data\\Calendar\\Meeting\\createMeetingdataDailyNew1.json");
