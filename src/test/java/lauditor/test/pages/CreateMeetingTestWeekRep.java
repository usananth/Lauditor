...
public class CreateMeetingTestWeekRep extends BaseClass {
	...
	public Object[][] getData0() throws IOException {
		...
		List<HashMap<String, String>> data = getJsonDataToMap(
				"F:\\ANANTH\\Eclipse-Workspace\\Law\\src\\test\\java\\Data\\Calendar\\Meeting\\createMeetingdataWeekly.json");
		...
		return new Object[][] { /*
								 ...
								 * data.get(44) }, { data.get(45) }, { data.get(46) }, { data.get(47) }, {
								 * data.get(48) }, { data.get(49) }, { data.get(50) }, { data.get(51) }, {
								 * data.get(52) }, { data.get(53) }, { data.get(54) }, { data.get(55) }, {
								 * data.get(56) }, { data.get(57) }, { data.get(58) },
								 */{ data.get(59) } };
