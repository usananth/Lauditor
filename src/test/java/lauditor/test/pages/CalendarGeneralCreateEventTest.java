...
public class CalendarGeneralCreateEventTest extends BaseClass {
	...
	public void Calendar_GM_MandatoryFields_Allday(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.InnerScroll();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
			calendarGeneralEventPage.ScrollToUp();
			Thread.sleep(2000);
			calendarGeneralEventPage.AssertMeetingName(input.get("AssertEName"));
		} finally {
			calendarGeneralEventPage.MeetingsSideMenu();
	...
	public void Calendar_GM_MandatoryFields_MeetingLink(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.EventDatePickerSelection(input.get("Eventdate"), input.get("Eventmonth"),
					input.get("Eventyear"));
			calendarGeneralEventPage.EventStratTime(input.get("EStartTime"));
			calendarGeneralEventPage.MeetingLinkField(input.get("MeetLink"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
			...
			Thread.sleep(2000);
			calendarGeneralEventPage.AssertMeetingName(input.get("AssertEName"));
			calendarGeneralEventPage.AssertMeetingLink(input.get("AssertMLink"));
	...
	public void Calendar_GM_MandatoryFields_DialupNumber(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.EventDatePickerSelection(input.get("Eventdate"), input.get("Eventmonth"),
					input.get("Eventyear"));
			calendarGeneralEventPage.EventStratTime(input.get("EStartTime"));
			calendarGeneralEventPage.DialUpNumber(input.get("DialupNumber"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
			...
			Thread.sleep(2000);
			calendarGeneralEventPage.AssertMeetingName(input.get("AssertEName"));
			calendarGeneralEventPage.AssertDialupNumber(input.get("AssertDNumber"));
	...
	public void Calendar_GM_MandatoryFields_Location(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.EventDatePickerSelection(input.get("Eventdate"), input.get("Eventmonth"),
					input.get("Eventyear"));
			calendarGeneralEventPage.EventStratTime(input.get("EStartTime"));
			calendarGeneralEventPage.EventLocation(input.get("ELocation"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
	...
	public void Calendar_GM_MandatoryFields_MeetingAgenda(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.EventDatePickerSelection(input.get("Eventdate"), input.get("Eventmonth"),
					input.get("Eventyear"));
			calendarGeneralEventPage.EventStratTime(input.get("EStartTime"));
			calendarGeneralEventPage.MeetingAgenda(input.get("EAgenda"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
			...
			Thread.sleep(2000);
			calendarGeneralEventPage.AssertMeetingName(input.get("AssertEName"));
			calendarGeneralEventPage.AssertMeetingAgenda(input.get("AssertAgenda"));
		} finally {
			calendarGeneralEventPage.MeetingsSideMenu();
	...
	public void Calendar_GM_MandatoryFields_TeamMember(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.ScrollDownTM();
			Thread.sleep(4000);
			calendarGeneralEventPage.AddTeamMember(input.get("TeamMember1"));
			calendarGeneralEventPage.AddTeamMember(input.get("TeamMember2"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
			...
			Thread.sleep(3000);
			calendarGeneralEventPage.AssertMeetingName(input.get("AssertEName"));
			calendarGeneralEventPage.AssertTeamMember(input.get("TeamMember1"));
		} finally {
			// calendarGeneralEventPage.MeetingsSideMenu();
	...
	public void Calendar_GM_MandatoryFields_AddEntity(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.ScrollDownTM();
			Thread.sleep(4000);
			calendarGeneralEventPage.AddEntityFirmSelect(input.get("EntityFirmName"));
			calendarGeneralEventPage.AddEntityMemberSelect(input.get("EntityMemberName"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
	...
	public void Calendar_GM_MandatoryFields_AddDocuments(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.ScrollDownTM();
			Thread.sleep(3000);
			calendarGeneralEventPage.AddDocuments(input.get("DocumentName1"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
			...
			Thread.sleep(3000);
			calendarGeneralEventPage.AssertMeetingName(input.get("AssertEName"));
			calendarGeneralEventPage.AssertDocuments(input.get("DocumentName1"));
		} finally {
			// calendarGeneralEventPage.MeetingsSideMenu();
	...
	public void Calendar_GM_MandatoryFields_AddIndividual(HashMap<String, String> input)
		...
		try {
			...
			calendarGeneralEventPage.ScrollDownTM();
			Thread.sleep(3000);
			calendarGeneralEventPage.AddIndividuals(input.get("IndividualClient1"));
			calendarGeneralEventPage.EventSaveBtn();
			calendarGeneralEventPage.ESaveViewChanges();
			calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
			calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
			...
			Thread.sleep(3000);
			calendarGeneralEventPage.AssertMeetingName(input.get("AssertEName"));
			calendarGeneralEventPage.AssertEntityandIndividual(input.get("AssertIndEntity"));
		} finally {
			// calendarGeneralEventPage.MeetingsSideMenu();
	 ...
	 * throws InterruptedException, AWTException, IOException {
	 * 
	 * try { calendarGeneralEventPage.MeetingsSideMenu();
	 * calendarGeneralEventPage.CreateMeetingsBtn();
	 * calendarGeneralEventPage.GeneralMatterRadioBtn();
	 * calendarGeneralEventPage.MatterNameSelection(input.get("MatterName"));
	 * calendarGeneralEventPage.SubjectORTaskSelection(input.get("SubjectTaskName"))
	 * ; calendarGeneralEventPage.EventDatePickerSelection(input.get("Eventdate"),
	 ...
	 * calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
	 * calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
	 * calendarGeneralEventPage.ScrollToUp(); Thread.sleep(2000);
	 * calendarGeneralEventPage.AssertMeetingName(input.get("AssertCheck")); }
	 * finally { calendarGeneralEventPage.MeetingsSideMenu();
	 * 
	 * }
	 * 
	 * }
	 ...
	 * calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
	 * calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
	 * calendarGeneralEventPage.ScrollToUp(); Thread.sleep(3000);
	 * calendarGeneralEventPage.AssertMeetingName(input.get("AssertCheck")); }
	 * finally { calendarGeneralEventPage.MeetingsSideMenu();
	 * 
	 * }
	 ...
	 * calendarGeneralEventPage.RepetitionSelection(input.get("Repetition"));
	 * calendarGeneralEventPage.EventSaveBtn();
	 * calendarGeneralEventPage.ESaveViewChanges(); Thread.sleep(3000);
	 * 
	 * } finally { calendarGeneralEventPage.MeetingsSideMenu();
	 * 
	 * }
	 ...
	 * calendarGeneralEventPage.AllDayCheckBox();
	 * calendarGeneralEventPage.EventSaveBtn();
	 * calendarGeneralEventPage.ESaveViewChanges(); Thread.sleep(3000); } finally {
	 * calendarGeneralEventPage.MeetingsSideMenu();
	 * 
	 * }
	 * 
	 ...
	 * ); calendarGeneralEventPage.ScrollToUp(); Thread.sleep(3000); } finally { //
	 * calendarGeneralEventPage.MeetingsSideMenu();
	 * 
	 * }
	 * 
	 ...
	 * calendarGeneralEventPage.RightArrow_LeftArrow_Date(input.get("Eventdate"));
	 * // calendarGeneralEventPage.CalendarEventsCollection(input.get("EventName"));
	 * calendarGeneralEventPage.CalendarEventsCollection_Week(input.get("Eventweek")
