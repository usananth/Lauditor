...
public class ViewMeetingsPage extends AbstractClass {
	...
	public void assertMonthandTime(String name) throws InterruptedException {
		if (!name.equals("")) {
			String monthIndex[] = { "Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov",
					"Dec" };
			Thread.sleep(2000);
	...
	// Meeting Link
	@FindBy(xpath = "(//p[@class='meetingitem itemFlex'])[1]")
	...
	public void reptitionTextVerify1(String day1, String year1, String month1, String repeat1, String nameVerify,
			String meetName, String monthTime, String meetingAgen, String meetingLink, String PhoneNum, String Docum,
			String TM, String EntityFirm, String EntityMemb, String Individual) throws InterruptedException {
		...
		if (rpt < 3) // Daily, Weekly, BiWeek
		{
			...
			for (int j = 0; j < 1; j++) {
				...
				for (i = 0; i < (dateOneLoc + monthDayCount); i++) {
					if (i == monthStart) {
						...
						for (int k = 0; k < oneCell.length; k++) {
							...
							if (a.equals(nameVerify)) {
								...
								flag = 1;
								if (vCount < 7) {
									// System.out.println("Matched : "+a+" vCount : "+vCount+"k: "+k+"TimeLoc :
									// "+(timeLabelCount+k-1));
									Thread.sleep(2000);
					...
					// System.out.println("x = "+i+"Data : " + allCells.get(i).getText() + "Length :
					// "+ cellOne.length);
					timeLabelCount = timeLabelCount + (cellOne.length - 1);
					// System.out.println("Cell : "+i+"Length : "+ cellOne.length + "Total Count :
					// "+timeLabelCount);
	...
	// Daily , Week , Bi-Weekly
	public void reptitionTextVerify2(String day1, String year1, String month1, String repeat1, String nameVerify,
			String meetName, String monthTime, String meetingAgen, String meetingLink, String PhoneNum, String Docum,
			String TM, String EntityFirm, String EntityMemb, String Individual) throws InterruptedException {
